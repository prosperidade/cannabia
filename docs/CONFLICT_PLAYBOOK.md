...
## Estratégia preferencial: PR fatiado

Se o PR tiver muitos conflitos em arquivos de naturezas diferentes (infra + segurança + rotas + templates + docs), prefira quebrar em PRs menores.

Consulte o plano completo em: `docs/PR_FATIADO_PLAN.md`.

Resumo da ordem:
1. Infra/config/migration
2. Segurança transversal
3. Camada services/repositories/integrations
4. Rotas
5. Templates/UI
6. Documentação
