...
export type AppRole = "Admin" | "AdminClinica" | "Medico" | "Recepcao" | "Financeiro" | "Paciente";
...
export const ORG_NAV: CatalogItem[] = [
  // ── Geral
  {
    ...
    href: "/org/dashboard",
    visibleFor: {
      roles: ["Admin", "AdminClinica", "Medico", "Recepcao", "Financeiro"],
      orClinicAdmin: true,
    },
  },
  {
  ...
  {
    label: "Inteligencia Clinica",
    icon: "psychology",
    href: "/med/inteligencia",
    visibleFor: { roles: ["Admin", "Medico"] },
  },
  {
  ...
  {
    label: "Ensaios Clinicos",
    icon: "science",
    href: "/med/ensaios",
    visibleFor: { roles: ["Admin", "Medico"] },
  },
  {
    label: "Precisao Botanica",
    icon: "eco",
    href: "/med/botanical",
    visibleFor: { roles: ["Admin", "Medico"] },
  },
  ...
  },
  {
    label: "Sandbox",
    icon: "account_balance",
    href: "/org/sandbox/governance",
    visibleFor: {
      roles: ["Admin", "AdminClinica", "Medico"],
      orClinicAdmin: true,
      tenantTypes: ["association"],
    },
  },
...
export function filterNav(catalog: CatalogItem[], ctx: NavContext): SidebarNavItem[] {
  return catalog.filter((item) => isVisible(item, ctx)).map(({ visibleFor: _v, ...rest }) => rest);
}
