    ...
    <Card className={cn("ds-treatment", className)}>
      ...
      <div className="ds-treatment__grid">
        <div className="ds-treatment__block">
          <span className="ds-treatment__block-icon" aria-hidden="true">
            &#x2696;
          </span>
          <div>
      ...
      <div className="ds-treatment__evidence">
        ...
        {report.references.length > 0 ? (
          <details className="ds-treatment__refs">
            <summary>
              {report.references.length} referencia{report.references.length !== 1 ? "s" : ""}{" "}
              cientifica{report.references.length !== 1 ? "s" : ""}
            </summary>
