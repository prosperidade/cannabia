...
export function MobileLayout({
  ...
  return (
    <div className="min-h-screen bg-background text-on-background font-body">
      ...
      {/* ── Main Content ── */}
      <main id="main-content" className="pt-16 pb-24 px-4 space-y-6">
        {children}
      </main>
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 w-full h-20 flex justify-around items-center px-4 pb-4 bg-zinc-900/90 backdrop-blur-xl z-50 rounded-t-[2rem] border-t border-white/5 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]"
      >
