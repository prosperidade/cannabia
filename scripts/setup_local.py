...
def main():
    ...
    print("    dono          / dono123           -> /org/dashboard")
    print("    recepcao      / recepcao123       -> /org/acompanhamento")
    print("    financeiro    / financeiro123     -> /org/financeiro")
    print("    admin_clinica / adminclinica123   -> /org/dashboard")
